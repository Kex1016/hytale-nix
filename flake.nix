  ...
  outputs =
    ...
    let
      ...
      hytale-launcher-bin = pkgs.fetchzip {
        url = "https://launcher.hytale.com/builds/release/linux/amd64/hytale-launcher-2026.01.13-e6eb932.zip";
        sha256 = "sha256-ZXhMZjnaHsVzjnyNcTktQQyd2AUaNfkjan8XP/S3TxE=";
      };
    in
    {
